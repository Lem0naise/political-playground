...
RAND_PREF_EFFECT = 0.7 #0.7 before 
# mandatory voting
VOTE_MANDATE = False
...
CAND_LIST = {
    ...
    "POPE" : [
        Candidate(9, "Cardinal Pietro Parolin", "Vatican Secretariat of State", 10, # Diplomatic and experienced
            prog_cons= -10,
            nat_glob= 20,
            env_eco= 5,
            soc_cap= 10,
            ...
            rel_sec= 30,
            colour="gold"),
        Candidate(10, "Cardinal Luis Antonio Tagle", "Prefect of the Congregation for the Evangelization of Peoples", 8, # Charismatic and globalist
            prog_cons= -20,
            nat_glob= 40,
            env_eco= -10,
            soc_cap= -5,
            ...
            rel_sec= 50,
            colour="blue"),
        Candidate(11, "Cardinal Marc Ouellet", "Prefect of the Congregation for Bishops", 7, # Conservative and experienced
            prog_cons= 20,
            nat_glob= -10,
            env_eco= 10,
            soc_cap= 15,
            ...
            rel_sec= -20,
            colour="red"),
        Candidate(12, "Cardinal Christoph Schönborn", "Archbishop of Vienna", 6, # Moderate and intellectual
            prog_cons= 0,
            nat_glob= 10,
            env_eco= 0,
            soc_cap= 5,
            ...
            rel_sec= 25,
            colour="green"),
        Candidate(13, "Cardinal Robert Sarah", "Prefect Emeritus of the Congregation for Divine Worship", 5, # Traditionalist and spiritual
            prog_cons= 30,
            nat_glob= -20,
            env_eco= 15,
            soc_cap= 20,
            ...
            rel_sec= -30,
            colour="black"),
        Candidate(14, "Cardinal Matteo Zuppi", "Archbishop of Bologna", 6, # Pastoral and reformist
            prog_cons= -15,
            nat_glob= 25,
            env_eco= -5,
            soc_cap= -10,
    ...
    "MARRIAGE" : 
    [
            Candidate(0, "Yes", "Support Gay Marriage", 10,
                prog_cons=-50,
                nat_glob=30,
                env_eco=0,
                soc_cap=-40,
                ...
                auth_ana=20,
                rel_sec=50),
            Candidate(1, "No", "Oppose Gay Marriage", 10,
                prog_cons=50,
                nat_glob=-30,
                env_eco=0,
                soc_cap=40,
                ...
                auth_ana=-20,
                rel_sec=-50),
            Candidate(2, "Civil Unions Only", "Support Civil Unions", 5,
                prog_cons=-20,
                nat_glob=10,
                env_eco=0,
                soc_cap=-10,
                ...
                auth_ana=10,
                rel_sec=20),
            Candidate(3, "No Legal Recognition", "Oppose All Recognition", 5,
                prog_cons=70,
                nat_glob=-40,
                env_eco=0,
                soc_cap=60,
    ...
    "RUNOFFTEST" : [
        Candidate(8, "Professor Halford", "Anti-Work Party", 5,
            prog_cons= 30,
            nat_glob= -30,
            env_eco= 20,
            soc_cap= -25,
            ...
            rel_sec = -20,
            colour="purple"),
                Candidate(8, "Mario Mario", "Hard Workers' Party", 5,
            prog_cons= -10,
            nat_glob= 30,
            env_eco= 10,
            soc_cap= 25,
            ...
            auth_ana= 0,
            rel_sec = 50,),
                    Candidate(8, "Luigi Mario", "Working Hard Party", 5,
            prog_cons= -10,
            nat_glob= 30,
            env_eco= 10,
            soc_cap= 25,
    ...
    "UNIVERSITY" : [
        Candidate(8, "Professor Halford", "Hard Workers' Party", 5,
            prog_cons= -30,
            nat_glob= 30,
            env_eco= -20,
            soc_cap= 25,
        ...
        Candidate(1, "Tyler Liccia-Byrne", "Winners Party", 5,  # P&P + MRL
            prog_cons= 90,
            nat_glob= -90,
            env_eco= -10,
            soc_cap= 100,
    ...
    "KINGDOM OF KRESIMIRIA": [
        Candidate(0, "King Remus Toran", "Pro-Remus Front", 10,
            prog_cons = -30,
            nat_glob = 14,
            env_eco = -10,
            soc_cap =  -15,
            ...
            auth_ana= -3,
            rel_sec = 4),
        Candidate(0, "Tiras Uval", "Anti-Remus Front", 10,
            prog_cons = 50,
            nat_glob = -24,
            env_eco = 50,
            soc_cap =  52,
            ...
            auth_ana= -63,
            rel_sec = -58),
        Candidate(0, "Teodor Mannford", "Kruhl Alliance", 10,
            prog_cons = 60,
            nat_glob = -64,
            env_eco = 20,
            soc_cap =  -2,
    ...
    "KRESIMIRIA" : [
        Candidate(0, "Juraj Milovan", "Democratic Socialist Alliance", 10,
            prog_cons = -23,
            nat_glob = 42,
            env_eco = -11,
            soc_cap =  -3,
            ...
            auth_ana= -13,
            rel_sec = 18),
        Candidate(0, "Neda Orak", "Boscovian Movement for Liberation", 0.5,
            prog_cons = 32,
            nat_glob = -158,
            env_eco = 12,
            soc_cap = -34,
            ...
            auth_ana= 45,
            rel_sec = -67),
        Candidate(0, "Lena Koseva", "People's Liberal League", 5,
            prog_cons = -9,
            nat_glob = 15,
            env_eco = 12,
            soc_cap = 42,
            ...
            auth_ana= -5,
            rel_sec = 17),
        Candidate(0, "Vuk Ilenko", "National Unity Front", 10,
            prog_cons = 42,
            nat_glob = -35,
            env_eco = 23,
            soc_cap = -15,
            ...
            auth_ana= -50,
            rel_sec = -26),
        Candidate(0, "Mirko Svetin", "Civic Renewal Party", 1,
            prog_cons = 13,
            nat_glob = -15,
            env_eco = 44,
            soc_cap = 21,
            ...
            auth_ana= 10,
            rel_sec = -56),
        Candidate(0, "Alisa Droven", "Green Dawn", 1,
            prog_cons = -45,
            nat_glob = 2,
            env_eco = -51,
            soc_cap = -45,
            ...
            auth_ana= 12,
            rel_sec = 36),
         Candidate(0, "Sara Madovic", "Justice and Honour Party", 1,
            prog_cons = 72,
            nat_glob = -53,
            env_eco = 24,
            soc_cap = -45,
            ...
            auth_ana= -62,
            rel_sec = -56),
        Candidate(0, "Dragan Kolov", "NOK", 1,
            prog_cons = 94,
            nat_glob = -83,
            env_eco = 2,
            soc_cap = -15,
