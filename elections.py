...
new_again = False
TOO_FAR_DISTANCE = 0 # 185 Non-voter distance, (Higher number -> More voters) (adjust when add more values)
...
RAND_PREF_EFFECT = 0.5 # 0.85 Effect of the random region on voting (lower number / closer to 0 -> more effect)
...
def coalition(leader, results_a):
    ...
    while not majority:
        ...
        while perc < 0.47: # while do not have a majority go through the list of parties:
...
VOTING_DEMOS = {
    ...
    "DENMARK": {"pop": 50_843, "vals": {
                "social liberalism": 0.7,
                "social conservatism": 0.3,
...
#            colour="green"),
#        Candidate(4, "Nigel Farage", "Reform Party", 0.1, 95, -98, 65, 70, 90, -42, -3,
#            colour="black"),
#    ],
#    "US PRIMARIES": [
