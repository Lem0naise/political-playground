      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mt-4">
          <p className="text-slate-400 text-xs">
            Created by <a href="https://indigo.spot" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:text-blue-300 underline transition-colors">Indigo Nolan</a>
          </p>
        </div>
      </div>
    </div>
