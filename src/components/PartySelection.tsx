      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
          {Object.entries(partyLists).map(([listName, parties]) => (
            <div
              key={listName}
              className={`vintage-border p-6 cursor-pointer transition-all duration-200 ${
            ...
            >
              <h3 className="newspaper-header text-2xl font-bold text-white mb-4">{listName}</h3>
              <p className="text-slate-300 mb-4 font-mono">{parties.length} PARTIES</p>
                ...
                {parties.slice(0, 4).map((party, index) => (
                  <div key={index} className="flex items-center space-x-3">
                    ...
                    <div className="flex-1">
                      <div className="font-medium text-sm text-white">{party.party}</div>
        ...
        {selectedList && (
          <div className="vintage-border p-6 mb-8" style={{ background: 'var(--newspaper-bg)' }}>
            <h3 className="newspaper-header text-2xl font-black text-slate-900 mb-4 border-b-2 border-slate-800 pb-2">
        ...
        <div className="flex justify-between">
          ...
          <button
            ...
            className="px-12 py-4 bg-gradient-to-r from-red-600 to-red-500 hover:from-red-700 hover:to-red-600 disabled:from-gray-600 disabled:to-gray-600 text-white font-bold rounded-lg transition-all duration-200 transform hover:scale-105 campaign-status"
          >
