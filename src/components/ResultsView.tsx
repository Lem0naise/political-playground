        ...
        <div className="text-center mt-6 sm:mt-8">
          ...
          <div className="border-t border-gray-600 pt-4">
            ...
            <p className="text-gray-400 text-xs mt-3">
              Visit <a href="https://indigo.spot" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:text-blue-300 underline font-medium transition-colors">indigo.spot</a> for more projects
            </p>
          </div>
        </div>
      </div>
