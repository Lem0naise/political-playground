        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center">
            ...
            <p className="text-slate-300 text-xs mt-4">
              Created by <a href="https://indigo.spot" target="_blank" rel="noopener noreferrer" className="text-blue-300 hover:text-blue-200 underline transition-colors">Indigo Nolan</a>
            </p>
          </div>
        </div>
      </div>
