      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
        ...
        <div className="text-center mt-6 sm:mt-8">
          <p className="text-slate-400 text-xs sm:text-sm font-mono mb-2">
            Tribune Interactive • Political Simulation Division • Created by <a href="https://indigo.spot" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:text-blue-300 underline transition-colors">Indigo Nolan</a>
          </p>
          ...
          <p className="text-slate-500 text-xs">
            All content is simplified for gameplay and should not influence real voting decisions. • <a href="https://indigo.spot" target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-slate-300 underline">indigo.spot</a> • version 0.7.0
          </p>
        </div>
      </div>
    </div>
